...
int main(int argc, const char **argv)
{
  ...
  char * multiplicand__region_buffer = (char *) __astex_memalloc(262);
  __astex_write_message("Reading multiplicand value from %s\n", argv[1]);
  __astex_read_from_file(multiplicand__region_buffer, 262, codelet_data_file_descriptor);
