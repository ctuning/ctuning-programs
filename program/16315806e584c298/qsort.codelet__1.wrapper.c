/* 
 ...
 3 "./qsort.codelet__1.wrapper.c" 3 4
*/
...
int main(int argc, const char **argv)
{
  ...
  char * a__region_buffer = (char *) __astex_memalloc(1440000);
  __astex_write_message("Reading a value from %s\n", argv[1]);
  __astex_read_from_file(a__region_buffer, 1440000, codelet_data_file_descriptor);
  a = (char *) (a__region_buffer + 433824l);
  char * b__region_buffer = (char *) __astex_memalloc(1440000);
  __astex_write_message("Reading b value from %s\n", argv[1]);
  __astex_read_from_file(b__region_buffer, 1440000, codelet_data_file_descriptor);
  b = (char *) (b__region_buffer + 0l);
