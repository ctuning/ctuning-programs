/* 
 ...
 3 "./tiffmedian.codelet__1.wrapper.c" 3 4
*/
...
{
  C_cell  *ptr;
  C_cell  **__astex_addr__astex_what_return;
  ...
  char * ptr__region_buffer = (char *) __astex_memalloc(2052);
  __astex_write_message("Reading ptr value from %s\n", argv[1]);
  __astex_read_from_file(ptr__region_buffer, 2052, codelet_data_file_descriptor);
  ptr = (C_cell *) (ptr__region_buffer + 0l);
  ...
  __astex_addr__astex_what_return = (C_cell **) (__astex_addr__astex_what_return__region_buffer + 0l);
  ...
  {
    --_astex_wrap_loop;
  astex_codelet__1(ptr, __astex_addr__astex_what_return, __astex_addr__astex_do_return);
