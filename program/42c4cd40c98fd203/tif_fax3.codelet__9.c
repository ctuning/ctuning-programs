...
#pragma hmpp astex_codelet__9 , args[__astex_addr__astex_do_return].io=out &
#pragma hmpp astex_codelet__9 , args[__astex_addr__astex_what_return].io=out &
#pragma hmpp astex_codelet__9 , args[oneruns].io=in &
#pragma hmpp astex_codelet__9 , args[bp].io=in &
        ...
        while ( !((((u_long ) (bp)) & (sizeof (long ) - 1)) == 0))
          {
            if (*bp != 0xff)
              {
                astex_what_return = (span + oneruns[*bp]);
                astex_do_return = 1;
goto astex_thread_end;
              }
            span += 8, bits -= 8;
