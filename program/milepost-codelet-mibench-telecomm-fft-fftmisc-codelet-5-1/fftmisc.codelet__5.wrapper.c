/* 
 ...
 3 "./fftmisc.codelet__5.wrapper.c" 3 4
*/
...
{
  unsigned  index = 0u;
  unsigned  NumBits = 15u;
  unsigned  *__astex_addr__astex_what_return;
  ...
  __astex_addr__astex_what_return = (unsigned *) (__astex_addr__astex_what_return__region_buffer + 0l);
  ...
  {
    --_astex_wrap_loop;
  astex_codelet__5(index, NumBits, __astex_addr__astex_what_return, __astex_addr__astex_do_return);
