/* 
 ...
 3 "./tif_fax3.codelet__8.wrapper.c" 3 4
*/
...
int main(int argc, const char **argv)
{
  ...
  char * zeroruns__region_buffer = (char *) __astex_memalloc(256);
  __astex_write_message("Reading zeroruns value from %s\n", argv[1]);
  __astex_read_from_file(zeroruns__region_buffer, 256, codelet_data_file_descriptor);
  zeroruns = (const u_char *) (zeroruns__region_buffer + 0l);
  ...
  {
    --_astex_wrap_loop;
  astex_codelet__8(bp, bs, zeroruns, bits, __astex_addr__astex_what_return, __astex_addr__astex_do_return);
