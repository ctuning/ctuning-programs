/* 
 ...
 3 "./jfdctint.codelet__2.wrapper.c" 3 4
*/
...
int main(int argc, const char **argv)
{
  ...
  char * dataptr__region_buffer = (char *) __astex_memalloc(256);
  __astex_write_message("Reading dataptr value from %s\n", argv[1]);
  __astex_read_from_file(dataptr__region_buffer, 256, codelet_data_file_descriptor);
  dataptr = (DCTELEM *) (dataptr__region_buffer + 0l);
