/* 
 ...
 3 "./tiffmedian.codelet__6.wrapper.c" 3 4
*/
...
int main(int argc, const char **argv)
{
  ...
  Colorbox  *b;
  int  size = -1;
  Colorbox  **__astex_addr__astex_what_return;
  ...
  char * usedboxes__region_buffer = (char *) __astex_memalloc(12288);
  __astex_write_message("Reading usedboxes value from %s\n", argv[1]);
  __astex_read_from_file(usedboxes__region_buffer, 12288, codelet_data_file_descriptor);
  usedboxes = (Colorbox *) (usedboxes__region_buffer + 0l);
  char * b__region_buffer = (char *) __astex_memalloc(0);
  b = (Colorbox *) (b__region_buffer + 0l);
  char * __astex_addr__astex_what_return__region_buffer = (char *) __astex_memalloc(8);
  __astex_write_message("Reading __astex_addr__astex_what_return value from %s\n", argv[1]);
  __astex_read_from_file(__astex_addr__astex_what_return__region_buffer, 8, codelet_data_file_descriptor);
  __astex_addr__astex_what_return = (Colorbox **) (__astex_addr__astex_what_return__region_buffer + 0l);
  ...
  {
    --_astex_wrap_loop;
  astex_codelet__6(usedboxes, b, size, __astex_addr__astex_what_return, __astex_addr__astex_do_return);
